...
describe('DateParser', () => {
  ...
  it('year 100 BCE', () => {
    ...
    expect(parser.parse('100 г. до нашей э.')).toEqual({
      days: -36159, title: '100 г. до нашей э.',
    });
  });
  ...
  it('date 17.08.0001 BCE', () => {
    ...
    expect(parser.parse('17.08.0001 до н.э.')).toEqual({
      days: 229, title: '17.08.0001 до н.э.',
    });
  });
